...
public extension AnimatableVariable where T: TransformInterpolation {
    ...
    func animation(_ desc: TransformAnimationDescription) -> MAnimation {
    ...
    func animation(from: Transform? = nil, to: Transform, during: Double = 1.0, delay: Double = 0.0) -> MAnimation {
    ...
    func animation(_ f: @escaping ((Double) -> Transform), during: Double = 1.0, delay: Double = 0.0) -> MAnimation {
        return TransformAnimation(animatedNode: node!, valueFunc: f, animationDuration: during, delay: delay)
    }

    func animation(angle: Double, x: Double? = .none, y: Double? = .none, during: Double = 1.0, delay: Double = 0.0) -> MAnimation {
    ...
    func animation(along path: Path, during: Double = 1.0, delay: Double = 0.0) -> MAnimation {
