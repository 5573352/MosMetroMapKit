...
public extension AnimatableVariable where T: DoubleInterpolation {
    ...
    func animation(_ desc: OpacityAnimationDescription) -> MAnimation {
    ...
    func animation(from: Double? = nil, to: Double, during: Double = 1.0, delay: Double = 0.0) -> MAnimation {
    ...
    func animation(_ f: @escaping ((Double) -> Double), during: Double = 1.0, delay: Double = 0.0) -> MAnimation {
