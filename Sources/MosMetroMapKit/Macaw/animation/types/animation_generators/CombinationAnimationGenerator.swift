...
extension AnimationProducer {
    ...
    func createChildAnimations(_ combineAnimation: MAnimation, animations: [MAnimation] = []) -> [MAnimation] {
    ...
    func addCombineAnimation(_ combineAnimation: MAnimation, _ context: AnimationContext) {
