...
class AnimationUtils {
    ...
    class func layerForNodeRenderer(_ renderer: NodeRenderer, animation: MAnimation, customBounds: Rect? = .none, shouldRenderContent: Bool = true) -> ShapeLayer {
    ...
    class private func calculateAnimationScale(animation: MAnimation) -> CGFloat {
