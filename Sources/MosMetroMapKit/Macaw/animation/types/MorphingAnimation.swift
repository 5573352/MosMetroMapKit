...
public extension AnimatableVariable where T: LocusInterpolation {
    ...
    func animation(_ desc: MorphingAnimationDescription) -> MAnimation {
    ...
    func animation(from: Locus? = nil, to: Locus, during: Double = 1.0, delay: Double = 0.0) -> MAnimation {
    ...
    func animation(_ f: @escaping (Double) -> Locus, during: Double, delay: Double = 0.0) -> MAnimation {
...
public extension AnimatableVariable where T: ContentsInterpolation {
    func animation(from: Group? = nil, to: [Node], during: Double = 1.0, delay: Double = 0.0) -> MAnimation {
