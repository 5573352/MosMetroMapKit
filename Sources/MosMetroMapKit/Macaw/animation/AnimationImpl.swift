...
class BasicAnimation: MAnimation {
    ...
    override open func delay(_ delay: Double) -> MAnimation {
        self.delay += delay
        return self
    }

    override open func cycle(_ count: Double) -> MAnimation {
        self.repeatCount = count
        return self
    }

    override open func easing(_ easing: Easing) -> MAnimation {
        self.easing = easing
        return self
    }

    override open func autoreversed() -> MAnimation {
        self.autoreverses = true

        return self
    }

    override open func cycle() -> MAnimation {
        self.cycled = true

        return self
    }

    override open func onComplete(_ f: @escaping (() -> Void)) -> MAnimation {
        self.completion = f
        return self
    }
    ...
    override open func reverse() -> MAnimation {
        return self
    }
